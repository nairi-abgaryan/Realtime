<div  ><select id='Person_C' name='region'  style='width:150px;height:28px;border:1px solid #ccc;'>
...
<div class='villagesearchresult' style='position: absolute;margin-left:160px;z-index:1'></div> ";<div class='add_centers'><button class='close_tarrif'>x</button>
<?php die();?>
